...
class PriceChecker:
    """Клас-директор, що координує роботу БД, парсера, ШІ та сповіщень."""
    
    def __init__(self, db_path: str, parser: PlaywrightParser, extractor: GeminiPriceExtractor):
    ...
    def check_all_prices(self) -> None:
        ...
        try:
            ...
            self.base_logger.info(f"З бази даних успішно зчитано {len(products)} товарів.")
        except sqlite3.Error:
            self.base_logger.exception("Критична помилка ініціалізації або читання SQLite")
            return
